...
class heatwaves2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_heatwaves2)
        setupBottomNavigation()
    }

    fun hwtoWebsite1(view: View) {
        val url = "https://knowledge.aidr.org.au/resources/heatwave/" // Replace this with your desired URL
        val hw2 = Intent(Intent.ACTION_VIEW, Uri.parse(url))
        startActivity(hw2)
    }

    fun movetoHW1(view: View) {
        val hw3 = Intent(this, heatwaves1::class.java)
        startActivity(hw3)
    }
